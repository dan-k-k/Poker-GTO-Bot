# app/range_predictor/train_range_predictor.py
"""
...
def main():
    ...
    parser.add_argument('--model_save_path', type=str, default='models/range_predictor.pt',
                        help='Path to save trained model')
    parser.add_argument('--batch_size', type=int, default=64, help='Batch size for training')
    parser.add_argument('--epochs', type=int, default=100, help='Number of training epochs')
    parser.add_argument('--learning_rate', type=float, default=0.001, help='Learning rate')
    parser.add_argument('--feature_dim', type=int, default=552, help='Feature vector dimension')
